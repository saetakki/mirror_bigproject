...
from .views import  (list_history, detail_or_delete_history, 
                     ...
                     signup, login, logout, find_id, find_password, create_dummy_data, delete_histories, bookmark_histories)
...
urlpatterns = [
    ...
    path('delete_histories/', delete_histories),
    path('bookmark_histories/', bookmark_histories),
