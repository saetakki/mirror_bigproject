    ...
    <HomeContainer>
      <HomeWrapper>
        <GNB>
          ...
          <Right>
            <span className='w-[6em] mb-2 break-normal flex text-center'>
              오늘도 연습을 시작해볼까요?
            </span>
            <PracticeBtn className='w-[9em]' onClick={() => navigate('/tts')}>
              {' '}
              연습 시작
            </PracticeBtn>
          </Right>
            ...
            <SectionLeft isMobile={isMobile} height={'300px'} isFirst={true}>
              <div className='h-full flex flex-col justify-between'>
                ...
                <div className='break-normal my-auto h-[120px] flex flex-col justify-between'>
                  <span>{uid}님은</span>
                  <span>
                    총 <strong>NUM번</strong>의 연습을 진행했고
                  </span>
                  <span>
                    총 <strong>NUM개</strong>의 연습을 북마크했어요.
                  </span>
                  <br />
                </div>
                <div></div>
          ...
          <SectionRightContainer isMobile={isMobile}>
            ...
            >
              ...
              <div className='h-12 flex flex-row w-full my-[20px] items-center justify-between'>
                <div
                  className={`${
                    isPractice ? 'text-blue-500 font-bold' : null
                  } w-[50%] text-center flex flex-col items-center`}
                  onClick={() => setIsPractice(!isPractice)}
                >
                  최근 5개 연습
                  <div
                    className={`${
                      isPractice ? 'h-1 w-[80%] bg-blue-500' : 'hidden'
                    }`}
                  />
                </div>
                <div
